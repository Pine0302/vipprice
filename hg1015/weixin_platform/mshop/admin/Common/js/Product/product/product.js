...
function saveProduct(e){
  ...
  // var imgids = $("#imgids").attr("value");
   ...
   var pro_vip_prices = document.getElementsByName("pro_vip_price");
   ...
   for(var i=0;i<len;i++){
	   ...
	   pro_vip_price = pro_vip_prices[i].value;
	   ...
	   var ts = proid+","+pro_orgin_price+"_"+pro_now_price+"_"+pro_vip_price+"_"+pro_storenum+"_"+pro_need_score+"_"+pro_cost_price+"_"+pro_foreign_mark+"_"+pro_unit+"_"+pro_weight+"_"+pro_for_price;
	   str = str +ts+"-";
   }
