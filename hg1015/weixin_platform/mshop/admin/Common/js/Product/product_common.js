...
$(function(){
	...
	$(".pro_priceimg").click(function(){
		...
		var price_v = $("#savepriceimg_"+pid).data("provprice");

		$("#span_price_title").html(pname);
		$.getJSON("ajax_operation.php",{id:pid,val_o:price_o,val_n:price_n,val_v:price_v,op:5},function(json){
			var array = eval(json);
			$("#WSY_t1").html("");
			var str = '';
			for (var i=0;i<array.length;i++){
				...
				str = str + '<td><input class="input_txprice" type="text" name="tx_provprice" value="'+v_price+'" />元</td>';
            ...
            v_price_str_before = v_price_str_before.substring(0,v_price_str_before.length-1);
	...
	$("#btn_changeprice").click(function(){
		...
		var v_price = $("input[name='tx_provprice']");
        ...
        var v_p = parseFloat(v_price.val());//现价
		...
		$(this).attr("disabled","disabled");
		$.getJSON("ajax_operation.php",{id:pid,aids:n_fpid_str,val_os:o_price_str,val_ns:n_price_str,val_vs:v_price_str,val_bs:b_price_str,val_cs:c_price_str,val_ss:n_score_str,op:6},function(json){
				if(json.code == 1){
					var price_o =  o_price[0].value;
					var price_n =  n_price[0].value;
					var price_v =  v_price[0].value;
					...
					$("#savepriceimg_"+pid).data("provprice",price_v);
					$("#pronprice_"+pid).data("costprice",price_c);
				};
            console.log('o_price_str='+o_price_str+';'+'n_price_str='+n_price_str+';'+'v_price_str='+v_price_str+';'+'b_price_str='+b_price_str+';'+'c_price_str='+c_price_str+';');
