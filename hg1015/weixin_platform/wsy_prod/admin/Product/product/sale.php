...
<div class="WSY_content" id="WSY_content_height">
	...
	//	$product = new Product();
		...
		$fields ="id,name,asort_value,type_id,type_ids,orgin_price,now_price,vip_price,cost_price,need_score,default_imgurl,isnew,createtime,isout,ishot,issnapup,isvp,is_virtual,is_currency,is_guess_you_like,is_free_shipping,isscore,islimit,is_first_extend,good_level,meu_level,bad_level,is_supply_id,create_type,sell_count,is_QR,storenum,tax_type,extend_money,back_currency,vp_score,buystart_time,countdown_time,limit_num,privilege_level,is_privilege,link_package,ordering_retail,is_mini_mshop,nowprice_title";
...
<!-- 							<li class="WSY_price01" id="prooprice_<?php echo $p_id;?>" >原价：<?php if(OOF_P != 2) echo OOF_S ?><?php echo $p_orgin_price; ?><?php if(OOF_P == 2) echo OOF_S ?></li>
 ...
 -->						
					...
					<td>
					<img src="<?php echo $imgurl; ?>" class="WSY_fixed"  />
					</td>
					<td>
