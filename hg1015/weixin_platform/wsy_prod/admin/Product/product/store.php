...
<div class="WSY_content" id="WSY_content_height">
	...
	<?php
	    ...
	    $query2="SELECT id,name,asort_value,type_id,type_ids,orgin_price,now_price,vip_price,for_price,cost_price,default_imgurl,isnew,createtime,isout,ishot,isnew,isvp,is_virtual,good_level,meu_level,bad_level,is_supply_id,create_type,sell_count,is_QR,storenum,tax_type ,privilege_level,ordering_retail,is_mini_mshop
