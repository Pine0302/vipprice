...
<!-- 修改产品属性 begin -->
	...
	<div id="div_out1">
		...
		<div class="div_out_item02" id="div_type_starttime"style="display:none;">
			<label>抢购开始时间：</label>
			<input id="buystart_time" type="text" name="buystart_time" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'2015-10-25 10:00',maxDate:'2018-10-25 21:30'});" style="width:14%;border:1px solid #ccc;" />
		</div>
		<div class="div_out_item02" id="div_type_endtime"style="display:none;">
			<label>抢购结束时间：</label>
			<input id="countdown_time" type="text" name="countdown_time" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'2015-10-25 10:00',maxDate:'2018-10-25 21:30'});" style="width:14%;border:1px solid #ccc;" />
		</div>
